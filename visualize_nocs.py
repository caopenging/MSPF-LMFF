...
parser.add_argument('--data', type=str, default='data', help='camera_val, real_test')  # NOCS dataset path
parser.add_argument('--result_dir', type=str, default='results/REAL',
                    help='result directory')  # REAL or CAMERA predicted results path
...
def visualize():
    ...
    for path in tqdm(img_list):
        ...
        image_short_path = '_'.join(img_path_parsing[2:])
        ...
        nocs_pkl_path = os.path.join('results/nocs_results/real_test', 'results_test_{}_{}.pkl'.format(
            img_path_parsing[-2], img_path_parsing[-1]))
        # load NOCS result _CAMERA
        # nocs_pkl_path = os.path.join('results/nocs_results/val', 'results_val_{}_{}.pkl'.format(
        #     img_path_parsing[-2], img_path_parsing[-1]))
        ...
        draw_detections(img, 'results/vis_results/test1', img_path_parsing[-2], img_path_parsing[-1],
                        ...
                        result['nocs_scales'], result['nocs_class_ids'], draw_nocs=True)
